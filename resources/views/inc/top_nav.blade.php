<nav class="navbar navbar-expand-lg navbar-light bg-primary border-bottom text-white">
    ...
    <button class="btn btn-primary navbar-toggler navbar-light" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
    ...
    <div class="d-flex align-items-center">
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-white text-center" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
