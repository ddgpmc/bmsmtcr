...
class ResidentAccountController extends Controller
{
    ...
    public function clientaccountsettingcheck(Request $request){
        ...
        $validator = Validator::make($request->all(),[
            ...
            "resident_accountsetting_email" => ["nullable", "ends_with:@gmail.com,@yahoo.com", "unique:residents,email,$id,resident_id"],
        ...
        if ($validator->fails()) {
            ...
            $query = DB::table('residents')->where("resident_id","=", $id)->update($values1);
